...
export const EnquiryModal: React.FC<EnquiryModalProps> = ({
  ...
  return (
    ...
    >
      <div
        className="relative w-full max-w-lg bg-white rounded-2xl shadow-2xl overflow-hidden border border-slate-100 my-8 transition-all"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Header banner */}
        <div className="bg-brand-navy px-6 py-5 text-white flex items-center justify-between">
          <div>
        ...
        <div className="p-6">
          {!isSubmitted ? (
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3.5 py-2.5 rounded-xl border border-slate-200 text-sm text-slate-800 focus:outline-none focus:ring-2 focus:ring-brand-accent/30 focus:border-brand-accent"
                  />
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    <select
                      ...
                      className="w-full px-3.5 py-2.5 rounded-xl border border-slate-200 text-sm text-slate-800 bg-white focus:outline-none focus:ring-2 focus:ring-brand-accent/30 focus:border-brand-accent appearance-none pr-8 cursor-pointer"
                    >
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      className="w-full px-3.5 py-2.5 rounded-xl border border-slate-200 text-sm text-slate-800 focus:outline-none focus:ring-2 focus:ring-brand-accent/30 focus:border-brand-accent cursor-pointer"
                    />
                  </div>
                </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-3.5 py-2 rounded-xl border border-slate-200 text-sm text-slate-800 focus:outline-none focus:ring-2 focus:ring-brand-accent/30 focus:border-brand-accent"
                />
              </div>
            ...
            <div className="text-center py-4 space-y-5 animate-fadeIn">
              ...
              <div className="border-t border-slate-100 pt-4 mt-4 grid grid-cols-2 gap-3 text-xs">
                <a
                  href={`tel:${siteConfig.contact.phone}`}
                  className="flex items-center justify-center gap-1.5 p-2.5 rounded-lg border border-slate-200 text-slate-700 hover:bg-slate-50 transition-colors"
                >
              ...
              <button
                ...
                className="text-xs text-slate-400 hover:text-slate-600 underline pt-2 block mx-auto cursor-pointer"
              >
                Modify details
              </button>
            </div>
