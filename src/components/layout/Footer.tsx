...
import { mainNavItems, quickDestinations } from "../../data/navigation";
    ...
    <footer className="bg-brand-navy-dark text-slate-300 pt-16 pb-12 border-t border-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 lg:gap-8 pb-12 border-b border-slate-800/80">
          {/* Column 1: Agency Brand & Bio (2 cols on lg) */}
          <div className="lg:col-span-2 space-y-4">
            <Link to="/" className="flex items-center gap-2.5 group">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-[10px] tracking-widest uppercase font-semibold text-brand-accent mt-0.5">
            ...
            <p className="text-sm text-slate-400 leading-relaxed max-w-sm">
              {siteConfig.shortDescription} Handcrafted holiday itineraries, family vacations, and honeymoon getaways tailored with personal care and local insight.
            </p>

            {/* Social handles - only show if URLs are configured */}
            {(siteConfig.social.instagram || siteConfig.social.facebook || siteConfig.social.youtube || siteConfig.social.twitter) && (
              <div className="flex items-center gap-3 pt-2">
                {siteConfig.social.instagram && (
                  <a
                    ...
                    className="w-9 h-9 rounded-lg bg-slate-800/80 hover:bg-brand-accent text-slate-300 hover:text-white flex items-center justify-center transition-colors"
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-400">
          ...
          <div className="flex items-center gap-6">
            <span>Govt. Registered Tour Operator</span>
            <span>•</span>
